  ...
  const projects = [
    {
      ...
      icon: <Server size={20} />,
      color: "blue-500 cyan-400" // Removed "from-" and "to-" prefixes
    },
    {
      ...
      demo: "https://example.com",
      icon: <Code size={20} />,
      color: "purple-500 pink-500" // Removed "from-" and "to-" prefixes
    },
    {
      ...
      demo: "https://example.com",
      icon: <Shield size={20} />,
      color: "green-500 emerald-400" // Removed "from-" and "to-" prefixes
    },
  ];
      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => {
            ...
            const colorParts = project.color ? project.color.split(' ') : ['primary', 'accent'];
            const firstColor = colorParts[0] || 'primary';
            const secondColor = colorParts[1] || 'accent';
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -inset-0.5 bg-gradient-to-br from-${firstColor} to-${secondColor} opacity-0 group-hover:opacity-50 blur-sm transition-opacity duration-500 -z-10`}></div>
                
                <div className={`h-3 w-full bg-gradient-to-r from-${firstColor} to-${secondColor} transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}></div>
